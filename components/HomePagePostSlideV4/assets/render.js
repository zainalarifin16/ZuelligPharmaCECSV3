	...
	ContentLayout.prototype = {
		...
		render: function(parentObj) {
			...
			try{
				...
				content.post_detail = {
					date: dateToMDY(content.data["blogpostv4_date"]),
					title: content.data["blogpostv4_title"],
					subtitle: content.data["blogpostv4_sub_title"],
					image: contentClient.getRenditionURL({
						'itemGUID': (content.data["blogpostv4_media_post"] instanceof Object) ? content.data["blogpostv4_media_post"].id : content.data["blogpostv4_media_post"],
						'contentType': contentType,
						'secureContent': secureContent
					}),
					category: content.data["blogpostv4_category_post"],
					summary: content.data["blogpostv4_summary"]					
				};
